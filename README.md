...
Fitting routine for spin-1 NMR signals with quadrupolar splitting Pake doublets, based on C code by C. Dulya [[1]](#1). Utilized to analyze signals from continuous-wave NMR Q-meter systems [[2]](#2).
...
Fits the complex signal — absorption and dispersion mixed by a phase angle. Adds parameter `phase`. The dispersion component is computed analytically as the Kramers-Kronig partner of the absorption lineshape, following Kisselev et al. (1995) [[3]](#3) and McClellan (2025). [[4]](#4)
...
<a id="2">[2]</a>
Maxwell, J. et. al. "A new cw-NMR Q-meter for dynamically polarized targets for particle physics"
NIM A, 1087, 171417 (2026). (https://doi.org/10.1016/j.nima.2026.171417)
